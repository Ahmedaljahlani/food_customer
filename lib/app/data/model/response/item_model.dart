...
class ItemData {
  ...
  factory ItemData.fromJson(Map<String, dynamic> json) => ItemData(
        ...
        itemunits: json["itemunits"] == null
            ? []
            : List<ItemUnit>.from(
                json["itemunits"]!.map((x) => ItemUnit.fromJson(x))),
        unitId: json["unit_id"],
...
/// Represents a single unit entry (e.g. ربع حبة, نص حبة, حبة) with its selling price.
class ItemUnit {
  ItemUnit({
    this.id,
    this.itemId,
    this.unitId,
    this.packageToSmallUnit,
    this.sellingPrice,
    this.isDefault,
    this.status,
    this.unit,
  ...
  factory ItemUnit.fromJson(Map<String, dynamic> json) => ItemUnit(
        ...
        itemId: json["item_id"],
        unitId: json["unit_id"],
        packageToSmallUnit: json["package_to_small_unit"],
        sellingPrice: (json["selling_price"] as num?)?.toDouble(),
        isDefault: json["is_default"],
        status: json["status"],
        unit: json["unit"] == null ? null : UnitInfo.fromJson(json["unit"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "item_id": itemId,
        "unit_id": unitId,
        "package_to_small_unit": packageToSmallUnit,
...
/// Represents the unit metadata (name, short_name).
class UnitInfo {
  UnitInfo({
    this.id,
    this.name,
