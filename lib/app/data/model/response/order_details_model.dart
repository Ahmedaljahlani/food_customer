...
class OrderItem {
  ...
  factory OrderItem.fromJson(Map<String, dynamic> json) => OrderItem(
        ...
        itemId: json["item_id"] is int ? json["item_id"] : int.tryParse(json["item_id"]?.toString() ?? ''),
        itemName: json["item_name"],
        itemImage: json["item_image"],
        quantity: json["quantity"] is int ? json["quantity"] : (double.tryParse(json["quantity"]?.toString() ?? '')?.toInt()),
        discount: json["discount"],
        price: json["price"],
