                ...
                Scaffold(
                  ...
                  body: GetBuilder<HomeController>(
                    builder: (homeController) => Stack(
                          children: [
                            Padding(
                              padding: homeController.activeOrderData.isEmpty || box.read('isLogedIn') == false
                                      ? EdgeInsets.only(left: 0.h, right: 0.h)
                                      : EdgeInsets.only(left: 0.h, right: 0.h, bottom: 100.h,),
                              child: Column(
                                children: [
                                  SizedBox(
                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: Stack(
                                          children: [
                                            Column(
                                              children: [
                                                homeController.menuLoader || homeController.categoryDataList.isEmpty
                                                    ? menuSectionShimmer()
                                                    : homeMenuSection(),
                                                homeController.featuredLoader || homeController.featuredItemDataList.isEmpty
                                                    ? featureditemSectionShimmer()
                                                    : featureditemSection(),
                                                Get.find<OfferController>().offerDataList.isEmpty || Get.find<OfferController>().lodear
                                                    ? const SizedBox.shrink()
                                                    : homeOfferSection(),
                                                homeController.popularLoader || homeController.popularItemDataList.isEmpty
                            ...
                            if (homeController.activeOrderData.isNotEmpty && box.read('isLogedIn') == true)
