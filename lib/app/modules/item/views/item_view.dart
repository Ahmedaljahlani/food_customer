...
import '../../../../widget/price_with_symbol_widget.dart';
...
class _ItemViewState extends State<ItemView> {
  ...
  void initState() {
    ...
    setState(() {
      // Use the selected unit price; fall back to item's base convert_price.
      final unitPrice = homeController.selectedItemUnit.value?.sellingPrice
      ...
      totalPrice = homeController.itemDetailsData.value.offer!.isNotEmpty
          ...
          : unitPrice * Get.find<CartController>().itemQuantity;
              ...
              SingleChildScrollView(
                ...
                child: Obx(
                  () => Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      // ── Unit selector (only shown when item has multiple units) ──
                      if ((homeController.itemDetailsData.value.itemunits ?? []).length > 1)
                        Obx(() {
                          final units = homeController.itemDetailsData.value.itemunits!;
                          final selected = homeController.selectedItemUnit.value;
                          return Padding(
                            padding: EdgeInsets.only(
                                bottom: 12.h, left: 16.w, right: 8.w),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(height: 2.h),
                                                  PriceWithSymbol(
                                                    price: unit.sellingPrice?.toStringAsFixed(2) ?? '0.00',
                                        ...
                                        child: SingleChildScrollView(
                                          ...
                                          child: Row(
                                            children: List.generate(
                                              (homeController.itemDetailsData.value.variations![homeController.itemDetailsData.value.itemAttributes![y].id.toString()] as List? ?? []).length,
                                              (x) {
                                                final variationItem = homeController.itemDetailsData.value.variations![homeController.itemDetailsData.value.itemAttributes![y].id.toString()][x];
                                                final isSelected = homeController.variationList[y].id == variationItem['id'];
                                                final variationName = variationItem['name'].toString();
                                                final rawPrice = double.tryParse(variationItem['convert_price'].toString()) ?? 0.0;
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () {
                                                      if ((homeController.variationList.every((item) => item.id != variationItem['id']))) {
                                                        homeController.variationList[y] = ((Variations(
                                                          id: variationItem['id'],
                                                          itemId: homeController.itemDetailsData.value.id,
                                                          itemAttributeId: int.parse(variationItem['item_attribute_id'].toString()),
                                                          name: variationItem['name'],
                                                          variationName: homeController.itemDetailsData.value.itemAttributes![y].name,
                                                          price: rawPrice,
                                                        )));
                                                      }
                                                      calculate();
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    children: List.generate(
                                      (homeController.itemDetailsData.value.extras ?? []).length,
                                      (index) {
                                        final extraItem = homeController.itemDetailsData.value.extras![index];
                                        final isSelected = cartController.selectedExtraIndex.contains(index);
                                        final extraName = extraItem.name.toString();
                                        final rawPrice = double.tryParse(extraItem.convertPrice?.toString() ?? '') ?? double.tryParse(extraItem.price?.toString() ?? '') ?? 0.0;
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            borderRadius: BorderRadius.circular(8.r),
                                            onTap: () {
                                              if (cartController.selectedExtraIndex.contains(index)) {
                                                cartController.selectedExtraIndex.remove(index);
                                                extraList.removeWhere((item) => item.id == extraItem.id);
                                              } else {
                                                cartController.selectedExtraIndex.add(index);
                                                if (extraList.every((item) => item.id != extraItem.id)) {
                        ...
                        ElevatedButton(
                          ...
                          child: Row(
                            children: [
                              ...
                              PriceWithSymbol(
                                price: cartTotal.toStringAsFixed(2),
                                style: fontMedium,
                                maxWidth: 100.w,
                              ),
                            ],
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  ...
                  final unitPrice = hc.selectedItemUnit.value?.sellingPrice ?? itemDetails.convertPrice ?? 0.0;
                  final String displayPrice = unitPrice.toStringAsFixed(2);

                  return itemDetails.offer!.isNotEmpty
                      ? Row(
                          children: [
                            PriceWithSymbol(
                              price: displayPrice,
                            ...
                            SizedBox(width: 4.w),
                            PriceWithSymbol(
                              price: itemDetails.offer![0].currencyPrice!,
