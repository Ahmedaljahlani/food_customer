...
class CartController extends GetxController {
  ...
  addItem(ItemData mainItem, extra, variationList, totalPrice, variationSum,
    ...
    // Use the selected unit price; fall back to item's base convertPrice.
    ...
    cart.add(Cart(
        ...
        itemPrice: mainItem.offer!.isEmpty ? unitPrice : mainItem.offer![0].convertPrice,
        unitId: homeController.selectedItemUnit.value?.unitId,
        ...
        totalPrice: mainItem.offer!.isEmpty
            ? unitPrice + variationSum + extraSum
