...
dynamic langValue = const Locale('ar');
...
void main() async {
  ...
  if (box.read('languageCode') != null) {
    langValue = Locale(box.read('languageCode'));
  }
  ...
  runApp(
    ScreenUtilInit(
      ...
      builder: ((context, child) => GetMaterialApp(
        ...
        theme: ThemeData(useMaterial3: false, fontFamily: 'Tajawal'),
        locale: langValue,
        fallbackLocale: const Locale('ar'), // Add fallback to Arabic
